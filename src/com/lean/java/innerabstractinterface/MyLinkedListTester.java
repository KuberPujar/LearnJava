...
public class MyLinkedListTester {
	...
	public static void main(String[] args) {
		...
		/*
		 * MyLinkedList list = new MyLinkedList(null); list.traverse(list.getRoot());
		 * 
		 * String cities = "5 7 8 9 6 3 2 1 5 4 7 8"; String[] ss = cities.split(" ");
		...
		String numbers = "5 7 8 9 6 3 2 1 5 4 7 8";
